...
public class Moana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moana);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String url="https://www.youtube.com/watch?v=LKFuXETZUsI";
        ...
        text3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url="https://yts.lt/movie/moana-2016";
                Intent i=new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
        ...
        Moanafetch fetchdata=new Moanafetch();
        fetchdata.execute();
    }
}
